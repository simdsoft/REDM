...
namespace DMAttr
{
	...
	{
	public:
		static const char* bool_bautogroup;                                ///< 是否自动加入组,同一个父窗口下的组radio不会被tab切换焦点,示例:bautogroup="1"
		...
		static const char* SKIN_radioskin;                                 ///< radio图,8分图或2分图或1分图,前4为未选中四种状态，后4为选中时四种状态,示例:radioskin="PNG:radiobutton"
