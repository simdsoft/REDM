...
namespace DM
{
	...
	public:
		...
		//---------------------------------------------------
		HWND DM_CreateWindow(LPCSTR lpszXmlId,int x=0, int y=0, int nWidth=0, int nHeight=0, HWND hWndParent=NULL, int shadowStyle=NWSDS_NULL);///< 创建窗口
		...
		// Function Des: XML
		//---------------------------------------------------
		DMCode LoadDMData(LPCSTR lpszXmlId);									///< 解析XML
