...
namespace DMLUA
{
	...
	template<>	HWND				read(lua_State *L, int index);//dm
	template<>	HDC					read(lua_State *L, int index);//dm
	template<>	HICON				read(lua_State *L, int index);//dm
	template<>	HBITMAP				read(lua_State *L, int index);//dm
	template<>	HINSTANCE			read(lua_State *L, int index);//dm
	...
	template<>	void push(lua_State *L, HWND ret);//dm
	template<>	void push(lua_State *L, HDC ret);//dm
	template<>	void push(lua_State *L, HICON ret);//dm
	template<>	void push(lua_State *L, HBITMAP ret);//dm
	template<>	void push(lua_State *L, HINSTANCE ret);//dm
	...
	{
	public:
		lua_context(){m_L = DMLUA::open();}
		lua_context(lua_State* L){m_L = L;}
		~lua_context(){DMLUA::close(m_L);}
