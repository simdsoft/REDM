...
{
	CStringA str = "face:微软雅黑,size:0,weight:400,charset:134,underline:1,italic:1,strike:1,adding:0";
	DUIFontPool fontpool;
	fontpool.SetDefaultFont(str);
	IDMFontPtr pDefFont = fontpool.GetFont("");// 取得默认字体
	IDMFontPtr pDFont = fontpool.GetFont("size:0,weight:400"); //第一次创建
	IDMFontPtr pFont1 = fontpool.GetFont("size:0,weight:400"); //第二次取得
