...
{
	{PROJMENU_OPENDIR,			"     打开目录"},//0 
	{PROJMENU_SCAN,				"     扫描错误"},//1 
	{PROJMENU_ADDSKINPOOL,		"     增加皮肤池"},//2 
	{PROJMENU_DELSKINPOOL,		"     删除皮肤池"},//3 
	{PROJMENU_EDITSKINPOOL,		"     编辑皮肤池"},//4 

	{PROJMENU_ADDSTYLEPOOL,		"     增加样式池"},//5 
	{PROJMENU_DELSTYLEPOOL,		"     删除样式池"},//6 
	{PROJMENU_EDITSTYLEPOOL,	"     编辑样式池"},//7 

	{PROJMENU_ADDSKIN,			"     增加皮肤"},//8 
	{PROJMENU_DELSKIN,			"     删除皮肤"},//9 
	{PROJMENU_EDITSKIN,			"     编辑皮肤"},//10 

	{PROJMENU_ADDSTYLE,			"     增加样式"},//11
	{PROJMENU_DELSTYLE,			"     删除样式"},//12
	{PROJMENU_EDITSTYLE,		"     编辑样式"},//13 

	{PROJMENU_ADDIMGTYPE,		"     增加img类型"},//14 
	{PROJMENU_DELIMGTYPE,		"     删除img类型"},//15 
	{PROJMENU_EDITIMGTYPE,		"     编辑img类型"},//16 

	{PROJMENU_ADDTHEME,			"     增加主题包"},//17 
	{PROJMENU_DELTHEME,			"     删除主题包"},//18 
	{PROJMENU_EDITTHEME,		"     编辑主题包"},//19
	{PROJMENU_SETDEFTHEME,		"     设置默认主题包"},//20

	{PROJMENU_ADDIMG,			"     增加IMG"},//21 
	{PROJMENU_DELIMG,			"     删除IMG"},//22
	{PROJMENU_EDITIMG,			"     编辑IMG"},//23

	{PROJMENU_ADDLAYOUT,		"     增加LAYOUT"},//24
	{PROJMENU_DELLAYOUT,		"     删除LAYOUT"},//25
	{PROJMENU_EDITLAYOUT,		"     编辑LAYOUT"},//26
};
	...
	do 
	{
		...
		if (hParent)
		{
			...
			if (0 == strText.CompareNoCase(PROJTREE_LAYOUTFILES))// 父窗口为布局文件列表
			{
				...
				if (0 == strText.CompareNoCase(_TEXT(XML_LAYOUT)))// 自身窗口为LAYOUT
				{
					XmlNode.InsertChildNode(XML_SEP);
					DMXmlNode XmlItem = XmlNode.InsertChildNode(XML_ITEM);
		...
		if (hParentParent)
		{
			...
			if (0 == strText.CompareNoCase(PROJTREE_LAYOUTFILES))// 父窗口的父窗口为布局文件列表
			{
				...
				Init_Debug_XmlBuf(XmlNode);
				if (0 == strText.CompareNoCase(_TEXT(XML_LAYOUT))) // 自身窗口为LAYOUT的子窗口
				{
					XmlItem = XmlNode.InsertChildNode(XML_ITEM);
