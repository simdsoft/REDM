	...
	{  
		...
		{  
			...
			else if (!m_strTip.IsEmpty())// 构建简单的str窗口
			{
				...
				CStringW strXml;
				strXml.Format(L"<dm  initsize=\"%d,%d\"><root pos=\"0,0,-0,-0\" ncmargin=\"1,1,1,1\" clrnc=\"pbgra(00,00,00,ff)\" clrbg=\"pbgra(e1,ff,ff,ff)\" font=\"weight:400,charset:0,underline:0,italic:0,strike:0,size:-12,face:新宋体\" text=\"%s\"/></dm>",rcWnd.Width(),rcWnd.Height(),m_strTip);
				int ulSize = 300;
